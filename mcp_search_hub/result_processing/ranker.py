...
def rank_by_weighted_score(results: List[SearchResult], source_weights: Dict[str, float]) -> List[SearchResult]:
    """
    ...
    return sorted(results, key=lambda x: x.metadata.get("weighted_score", 0.0), reverse=True)