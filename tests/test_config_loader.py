...
class TestConfigLoader:
    ...
    def test_get_env_with_fallback(self):
        ...
        result = ConfigLoader.get_env_with_fallback(
            "MISSING_KEY", "ANOTHER_MISSING", "default"
        )
    ...
    @patch.dict(
        os.environ, {"AUTH_MIDDLEWARE_ENABLED": "false", "AUTH_MIDDLEWARE_ORDER": "15"}
    )
...
class TestComponentSettings:
    ...
    @patch.dict(os.environ, {"COMPONENT_DEBUG": "true", "COMPONENT_ENABLED": "false"})
...
class TestMiddlewareSettings:
    ...
    @patch.dict(
        os.environ,
        {"RETRY_MIDDLEWARE_ENABLED": "false", "RETRY_MIDDLEWARE_ORDER": "25"},
    )
...
class TestUtilityFunctions:
    ...
    def test_create_settings_factory(self):
        ...
        CustomSettings = create_settings_factory(
            ComponentSettings, env_prefix="CUSTOM_", case_sensitive=True
        )
