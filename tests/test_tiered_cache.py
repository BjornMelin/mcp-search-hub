...
class TestQueryCache:
    ...
    def test_clear_all(self, search_query, search_response):
        ...
        # Different query
        key2 = cache.generate_key(SearchQuery(
            query="another query",
            max_results=5,
            raw_content=True
        ))
...
class TestTieredCache:
    ...
    def mock_redis(self):
        ...
        with patch("redis.asyncio.Redis.from_url") as mock_async_redis, \
    ...
    def test_memory_only_sync_operations(self, memory_only_cache, search_query, search_response):
    ...
    @pytest.mark.asyncio
    async def test_memory_only_async_operations(self, memory_only_cache, search_query, search_response):
    ...
    @pytest.mark.asyncio
    async def test_redis_cache_async_operations(self, redis_cache, mock_redis, search_query, search_response):
    ...
    @pytest.mark.asyncio
    async def test_cache_fallback_behavior(self, redis_cache, mock_redis, search_query, search_response):
