...
class TestErrorBoundary:
    ...
    async def test_error_boundary(self):
        ...
        should_retry, message = component.handle_error(ConnectionError("Failed to connect"))
        assert should_retry
...
class TestCompleteComponent:
    ...
    class TestCompleteComponent(CompleteComponentBase[ComponentConfig, str, Dict[str, Any]]):
