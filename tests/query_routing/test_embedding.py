...
class TestEmbeddingGenerator:
    ...
    def test_disk_cache(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with mock.patch.object(
                EmbeddingGenerator, "_setup_disk_cache", wraps=generator._setup_disk_cache
            ) as mock_setup:
    ...
    def test_generate_fallback(self):
        ...
        with mock.patch("mcp_search_hub.query_routing.ml_models.embedding.USE_ML", False):
            generator = EmbeddingGenerator()
    ...
    @pytest.mark.skipif(not USE_ML, reason="ML features disabled")
    @mock.patch("mcp_search_hub.query_routing.ml_models.embedding.EmbeddingGenerator.model")
