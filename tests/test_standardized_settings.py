...
"""
    ...
    def test_to_legacy_settings(self):
        ...
        assert legacy_settings.middleware.logging.sensitive_headers == ["header1", "header2"]
...
class TestIntegration:
    ...
    def test_production_like_configuration(self):
        ...
        assert app_settings.perplexity_api_key.get_secret_value() == "prod_perplexity_key"
        ...
        assert legacy_settings.middleware.auth.api_keys == ["prod_key1", "prod_key2", "prod_key3"]
