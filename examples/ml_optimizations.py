...
def benchmark_embedding_generation(
    ...
    """
    # Warm up
    logger.info(f"Warming up generator with a single text...")
...
def benchmark_similarity_calculation(
    ...
    """
    # Warm up
    logger.info(f"Warming up similarity with a single comparison...")
...
def generate_test_texts(count: int) -> List[str]:
    ...
    topics = [
        ...
        "computer vision", "neural networks", "deep learning", "big data",
        "quantum computing", "blockchain", "cybersecurity", "cloud computing",
        "internet of things", "augmented reality", "virtual reality",
        "autonomous vehicles", "robotics", "space exploration", "renewable energy",
        "biotechnology", "nanotechnology", "climate change", "global warming",
        "sustainable development", "public health", "education", "economics",
        "history", "politics", "philosophy", "psychology", "sociology", "anthropology",
    ]
    ...
    for _ in range(count):
        ...
        query_type = random.choice([
            "how to", "what is", "why is", "when did", "where can I", 
            "who invented", "best practices for", "top 10", "examples of",
            "definition of", "history of", "future of", "advantages of",
            "disadvantages of", "comparison of", "difference between",
            "relationship between", "impact of", "causes of", "effects of",
        ])
        
        # Add random specificity
        specificity = random.choice([
            "for beginners", "in 2025", "with Python", "using TensorFlow",
            "in business", "in healthcare", "in education", "in manufacturing",
            "for small businesses", "for enterprises", "for startups",
            "in developing countries", "in the United States", "in Europe",
            "in Asia", "in Africa", "in Australia", "in South America",
...
def main():
    ...
    for config in configs:
        ...
        try:
            ...
            logger.info(f"Benchmarking embedding generation...")
            ...
            logger.info(f"Benchmarking similarity calculation...")
    ...
    # Print summary
    logger.info("\n\n========== SUMMARY ==========")
    logger.info(f"{'Configuration':<25} {'Embedding (ms/text)':<20} {'Similarity (ms/comparison)':<25}")
    logger.info("-" * 70)
